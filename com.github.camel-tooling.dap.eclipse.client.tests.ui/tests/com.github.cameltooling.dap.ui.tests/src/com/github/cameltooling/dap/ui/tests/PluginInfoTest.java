...
import com.github.cameltooling.dap.reddeer.menu.AboutEclipsePage;

/**
 * Check Camel DAP Client plugin info (About Eclipse > Installation Details)
 *
 * @author fpospisi
 */
...
public class PluginInfoTest {
	...
	public static final String name = "Apache Camel DAP Client Extensions Plugin";
	public static final String version = "0.0.1";
	public static final String id = "com.github.camel-tooling.dap.eclipse.client";

	/**
	 * Checks if DAP Eclipse plugin has correct author, name, version and id.
	 */
	@Test
