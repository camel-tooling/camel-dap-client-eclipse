...
import com.github.cameltooling.dap.reddeer.condition.ResumeButtonIsAvailable;
...
public class StoppingOnBreakpointTest {
	...
	public void testInspectVariable() {
		...
		// Wait until resume button is available - stopped on breakpoint.
		new WaitUntil(new ResumeButtonIsAvailable(), TimePeriod.LONG);
